            ...
            <form action="{{ route('Articulos-store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row p-3">
                    <div class="col-lg-12 text-center">
                        <h1 class="fw-bold">CREADOR DE ARTICULOS</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 col-md-12 col-sm-12 p-3">
                        <div class="row">
                            <div class="col-12">
                                <div class=" fs-3 fw-bold">EDITOR</div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col p-0">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mt-3">
                                            <div class="form-floating mb-3">
                                                <input type="" class="form-control bg-transparent  @error('titulo_pagina') is-invalid @enderror"
                                                    name="titulo_pagina" id="titulo_pagina" autocomplete="off"
                                                    placeholder="Titulo del articulo" value="{{ old('titulo_pagina') }}">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="" class="">Imagen de portada</label>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <div class="form-floating">
                                                <textarea class="form-control bg-transparent  @error('resumen_articulo') is-invalid @enderror" name="resumen_articulo"
                                                    id="floatingTextarea2" style="height: 100px">{{ old('resumen_articulo') }}</textarea>
                                                <label for="floatingTextarea2" class="">Resumen</label>
